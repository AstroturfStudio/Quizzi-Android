...
fun ServerSocketMessage.toDomain(): ServerMessage = when (this) {
    ...
    is ServerSocketMessage.JoinedRoom -> ServerMessage.RoomJoined(
        roomId = roomId,
        success = success
    )
    ...
    is ServerSocketMessage.AnswerResult -> ServerMessage.AnswerResult(
        playerId = playerId,
        answer = answer,
        correct = correct
    )
    ...
    is ServerSocketMessage.RoundEnded -> ServerMessage.RoundEnded(
        cursorPosition = cursorPosition,
        correctAnswer = correctAnswer,
        winnerPlayerId = winnerPlayerId
    )

    is ServerSocketMessage.RoundUpdate -> ServerMessage.RoundUpdate(
